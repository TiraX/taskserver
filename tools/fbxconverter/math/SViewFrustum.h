...
namespace ti
{
	...
	*/
	struct SViewFrustum
	{
		...
		//!
		bool testPlane(u32 i, const aabbox3df& bbox) const;
		...
		//!
		bool testInsidePlane(u32 i, const aabbox3df& bbox) const;
	...
	*/
	...
	inline bool SViewFrustum::testPlane(u32 i, const aabbox3df& bbox) const
	{
	...
	inline bool SViewFrustum::testInsidePlane(u32 i, const aabbox3df& bbox) const
	{
